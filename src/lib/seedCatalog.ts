...
export async function seedCatalog(payload: Payload) {
  ...
  const settingsData: Record<string, unknown> = {
    ...
    homeCollections: [
      ...
      { title: 'Makeup', copy: 'Colour for everyday, and for the nights you dress up.', href: '/shop/beauty', category: categories.beauty },
      { title: 'Skincare', copy: 'Simple routines for skin that works hard.', href: '/shop/skincare', category: categories.skincare },
      { title: 'Perfumes', copy: 'A finishing note — light, lasting, or in between.', href: '/shop/perfumes', category: categories.perfumes },
    ],
