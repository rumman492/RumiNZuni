...
export const FEATURED = {
  eyebrow: 'Fresh for little ones',
  heading: 'Little Favourites',
  cta: 'Shop Kidswear',
  ctaLink: '/shop/kids-wear',
  emptyMessage: 'This collection is getting ready. Check back soon or explore another collection.',
}
...
export const HOME_PROMOS = [
  {
    ...
    copy: 'Shop with confidence and pay in PKR when your order arrives.',
  },
  {
    icon: 'shipping',
    title: 'From our door to yours',
    copy: 'We pack each order carefully. Delivery time depends on your city — shipping is shown at checkout.',
  },
  {
    icon: 'sparkles',
  ...
  },
  {
    ...
    copy: 'Questions about size or an order? Message us and we will help you through it.',
  },
]
